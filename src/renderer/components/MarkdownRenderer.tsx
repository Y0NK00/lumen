  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        p({ children }) {
          return (
            <p className="text-white/80 leading-7 mb-3 text-[0.925rem] break-anywhere">{children}</p>
          );
        },
        ...
        li({ children }) {
          return (
            <li className="text-white/80 leading-6 marker:text-white/30 break-anywhere">{children}</li>
          );
        },
